...
GAME_SPRITES = {}
GAME_SOUNDS = {}
PLAYER = 'gallery/sprites/Edit 1.png'
BACKGROUND = 'gallery/sprites/New.png'
...
def mainGame():
    ...
    playerFlapAccv = -10 # velocity while flying
    playerFlapped = False # It is true only when the plane is flying
